    ...
    with TRADE_DB_LOCK:
        ...
        try:
            ...
            c.execute(
                ...
                """,
                (
                    trade_id, "CHART_IMAGE", direction, entry, sl, tp,
...
if not use_vision:
    ...
    st.warning("يرجى إدخال مفتاح Hugging Face Public في الشريط الجانبي لتحليل الصور.")
else:
                ...
                if do_analyze:
                    ...
                    if analysis:
                        ...
                        st.error(
                            ...
                            "Hugging Face Public. تحقق من صلاحية مفتاح Hugging Face Public API، "
...
# ============================================================
# Hugging Face Public UI (الرأي الثاني)
# ============================================================

if strategy_result and strategy_result.get("groq_called"):
    with st.expander("🧠 الرأي الثاني (Hugging Face Public)"):
        if strategy_result.get("groq_available"):
            ...
            st.warning("🟠 تم استدعاء Hugging Face Public لكن لم تصل استجابة صالحة منه هذه الدورة.")
...
if vision_error and use_vision:
    st.error(f"⚠️ Vision AI (Hugging Face Public): {vision_error}")
